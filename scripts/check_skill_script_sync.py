...
b = (root / "skill" / "zotero-scholium" / "scripts" / "scholium.py").read_text(encoding="utf8")
if a != b:
    print("skill/zotero-scholium/scripts/scholium.py is out of sync with src/zotero_scholium/cli.py\n"
